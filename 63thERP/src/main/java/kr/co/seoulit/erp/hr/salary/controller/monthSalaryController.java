...
public class monthSalaryController {
	...
	@RequestMapping("/salary/findMonthSalary")
	...
	@RequestMapping(value="/salar/findYearSalary")
	...
	@PostMapping("salary/modifyMonthSalary") //월급여 마감  
	public ModelMap modifyMonthSalary(@RequestBody Map<String,ArrayList<MonthSalaryTO>> empcode1)
	{
		//, @RequestBody ArrayList<SlipBean> slipData
		//@RequestBody ArrayList<MonthSalaryTO> monthSalary
		//ArrayList<Object> empCode = data.get("empcode1");
		//modelMap = new ModelMap();
		System.out.println("나오나나 "+empcode1.get("empcode1"));
		//MonthSalaryTO empCodeList : empcode1.get("empcode1")
